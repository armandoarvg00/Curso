(function($) {
	...
	*********************************************/
	...
	$('#option-view-calender').click(function() { $('body,html').animate({scrollTop: $("#show-calendar").position().top}, 500); });
	$('#option-view-calender-mobile').click(function() { $('body,html').animate({scrollTop: $("#show-calendar").position().top}, 500); });

                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="envor-widget envor-about-widget">
                            ...
                            <div class="envor-widget-inner">
                                ...
                                <p class="contacts"><i class="fa fa-envelope"></i> <a href="mailto:<?php echo $params['mail']; ?>"><img src="img/correo_info_black.jpg"></a></p>
                                ...
                                <div class="quick_newsletter">
                                    <?php if ($_SERVER['QUERY_STRING'] == ''): ?>
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php endif; ?>  
                                            <input onkeypress="return soloLetras(event)" name="nombre" id="nombre" placeholder="Nombre(s)" class="text" type="text" required>
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="envor-widget envor-latest-tweets-widget">
                            ...
                            <p>
                            <h3>Aceptamos Tarjetas de <strong>Crédito/Débito</strong></h3>
                            <img src="https://impulseits.com/img/logotipo_paypal_pagos_tarjetas.jpg" />
                            </p>
                        </div>
                        <!--

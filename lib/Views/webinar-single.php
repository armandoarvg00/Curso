    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="envor-desktop-breadscrubs-inner">
          <a href="index.php?seccion=certificaciones">Webinars</a><i class="fa fa-angle-double-right"></i><?php echo $params['certificacion']['titulo'];?>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 col-md-9">
        ...
        <?php if(strlen($params['certificacion']['objetivos']) > 0):?>
          <article class="envor-post">
            <header>

    ...
    <div class="container">      
      <div class="row">        
        ...
        <div class="col-lg-3 col-md-3">
            ...
            <?php if($params['mostrar_campo_empresa'] == 1): ?>
              <p>
                  ...
                  <input type="text" id="empresa" maxlength="50" onkeypress="return soloLetras(event)" name="empresa" placeholder="Empresa S. A. de C. V." value="<?php echo $_POST['empresa']; ?>">
              </p>
            <?php endif;?>

            <p>
                <label for="nombre">Nombre completo:*</label>
                <input type="text" id="nombre" name="nombre" maxlength="50" onkeypress="return soloLetras(event)" placeholder="Nombre" required value="<?php echo $_POST['nombre']; ?>">
            </p>
            <p>
                <label for="mail">Correo electrónico:*</label>
                <input type="text" id="mail" maxlength="30" name="mail" placeholder="E-mail" required value="<?php echo $_POST['mail']; ?>">
            </p>
            ...
            <p style="display: none;">
                ...
                <input type="text" id="asunto" name="asunto" maxlength="50" onkeypress="return soloLetras(event)" placeholder="Asunto" value="Webinar: <?php echo $_GET['titulo_webinar']; ?>">
                <?php else: ?>
                <input type="text" id="asunto" name="asunto" maxlength="50" onkeypress="return soloLetras(event)" placeholder="Asunto" value="<?php echo $_POST['asunto']; ?>">
                <?php endif;?>
            </p>
            <p>
                <label for="telefono">Teléfono:*</label>
                <input type="number" maxlength="10" onkeypress="return soloNumeros(event)" id="telefono" name="telefono" placeholder="+52 0000-0000" value="<?php echo $_POST['telefono']; ?>">
            </p>
            <?php if($params['mostrar_campo_celular'] == 1): ?>
              <p style="display: none;">
                  <label for="nombre">Celular:*</label>
                  <input type="number" maxlength="10" id="celular" onkeypress="return soloNumeros(event)" name="celular" placeholder="+52" value="<?php echo $_POST['celular']; ?>">
              </p>
            <?php endif;?>
            <p>
              <label for="mensaje">Mensaje:*</label>
              <textarea onkeypress="return soloLetras(event)" style="min-width: 240px !important;" maxlength="100" id="mensaje" name="mensaje" required placeholder="Escriba su mensaje..."><?php echo $_POST['mensaje']; ?></textarea>
            </p>
        ...
        <div class="col-lg-6 col-md-6">
          ...
          <div class="panel panel-default" style="border: none; cursor: pointer; position: relative; width: 80%; margin: 0px auto 0px;" data-toggle="modal" data-target="#modal-sugerencias">
      ...
      <div class="modal-body">
        <form id="frm_sugerencias" style="margin-top: 0px; margin-bottom: 5px; padding: 0px;">
          ...
          <div class="form-group">
            ...
            <input type="text" maxlength="50" class="form-control" id="mail_sugerencia" name="mail_sugerencia" placeholder="ejemplo@impulseits.com">
          </div>

    ...
    <div class="row">
      <div class="col-lg-12">
        <div class="envor-desktop-breadscrubs-inner">
          <a href="index.php?seccion=certificaciones">Certificaciones</a><i class="fa fa-angle-double-right"></i><?php echo $params['certificacion']['titulo'];?>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-9 col-md-9">
        ...
        <?php if(strlen($params['subtitulos']['descripcion']) > 0):?>
          <article class="envor-post">
            <header>
      ...
      <div class="col-lg-3 col-md-3">
        ...
        <aside class="envor-widget envor-category-widget">
          <h3>Próximas <strong>certificaciones</strong></h3>
            ...
            <ul>
              <?php if(count($params['categorias']) > 0): ?>
                <?php foreach($params['categorias'] as $categoria): ?>
                  <li>
                    <p><a href="index.php?seccion=certificaciones&id_categoria=<?php echo $categoria['id_categoria'];?>"><i class="glyphicon glyphicon-folder-open"></i> <?php echo $categoria['categoria'];?></a> <a href="index.php?seccion=certificaciones&id_categoria=<?php echo $categoria['id_categoria'];?>"><i class="fa fa-rss"></i></a> <span></span></p>

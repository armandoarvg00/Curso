...
<?php include('componentes/calendario.php');?>
      ...
      <section class="envor-section envor-section-align-center envor-section-st1">
        <div class="container">
          <div class="row">
            <div class="col-lg-12">
              <h2>Certificaciones <strong>destacables</strong></h2>
                  ...
                  <?php foreach($params['certificaciones'] as $certificacion): ?>
                    <article class="envor-property-1 envor-padding-left-30 col-md-4 envor-margin-bottom-10">
                      <div class="envor-property-1-inner">
                        <?php if($certificacion['path_portada'] == ''):?>
                          <figure>
                            ...
                            <figcaption>
                                ...
                                <a href="index.php?seccion=certificaciones&id_curso=<?php echo $certificacion['id_curso']?>"><i class="fa fa-eye" style="margin-left: 30px;"></i></a>
                            </figcaption>
                          </figure>
                        <?php else: ?>
                          <figure>
                        ...
                        <?php endif;?>
                        <p class="title"><a href="index.php?seccion=certificaciones&id_curso=<?php echo $certificacion['id_curso']?>"><?php echo $certificacion['titulo']?></a></p>

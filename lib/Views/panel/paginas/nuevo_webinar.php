...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Agregar nuevo webinar</li>
  </ol>
</section>
    ...
    <div class="col-md-8">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-book"></i> Webinar</h3>
        </div><!-- /.box-header -->
        <div class="box-body">
      ...
      <div class="box">
        ...
        <div class="box-body">
          ...
          <div class="input-group">
            ...
            <input type="text" maxlength="100" id="fecha_inicia" name="fecha_inicia" class="form-control" placeholder="aaaa-mm-dd" value="<?php echo $params['informacion_curso']['fecha_inicia']; ?>">
          </div>
          <br>

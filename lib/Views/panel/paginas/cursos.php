...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Cursos en el sitio web</li>
  </ol>
</section>
                ...
                <?php if(count($params['informacion']) > 0): ?>
                  <?php foreach($params['informacion'] as $informacion): ?>
                    <tr>
                      ...
                      <?php endif; ?>
                      <td>
                        <a href="index.php?seccion=nuevo_curso<?php echo $_SESSION['QUERY_STRING'];?>&action=update&id_curso=<?php echo $informacion['id_curso'];?>" class="label label-success"><i class="fa fa-edit"></i> Editar </a>  - <a href="index.php?seccion=cursos<?php echo $_SESSION['QUERY_STRING'];?>&action=borrar&id_curso=<?php echo $informacion['id_curso'];?>" class="label label-danger"><i class="fa fa-trash"></i> Borrar </a>
                      </td>
                    </tr>
                  <?php endforeach; ?>
                <?php else: ?>
                  <tr>
                    <td colspan="5">
                      <a href="index.php?seccion=nuevo_curso<?php echo $_SESSION['QUERY_STRING'] ?>&action=add"><i class="fa-check-circle"></i> No se encontraron cursos. Haga clic aquí para agregar uno. </a>
                    </td>
                  </tr>
                <?php endif; ?>
            </tbody>
